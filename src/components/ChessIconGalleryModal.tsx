...
export const PIECE_SET_OPTIONS: PieceSetOption[] = [
  ...
  },
  {
    ...
    badge: 'Kid Favorite',
    descriptionEn: 'Adorable character icons with Horse (Knight) 🐴, Castle 🏰, Wizard 🧙‍♂️, and Royal Crown 👑.',
    descriptionVi: 'Bộ linh vật đáng yêu dành cho trẻ em với Ngựa (Mã) 🐴, Lâu Đài 🏰, Phù Thủy 🧙‍♂️ và Vương Miện 👑.',
  ...
  },
  {
    ...
    descriptionEn: 'Electric cyan and neon purple glowing outline icons with dark gaming atmosphere.',
    descriptionVi: 'Đường nét dạ quang phát sáng màu Cyan & Tím Neon cực ngầu phong cách Gaming Arcade.',
