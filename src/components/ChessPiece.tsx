          ...
          <path
            d={
              pType === 'p'
                ...
                : pType === 'n'
                ? 'M 22,10 C 32.5,11 38.5,18 31,29 C 31,30 31,31 32,32 L 32,35 L 13,35 L 13,32 C 14,31 14,30 14,29 C 14,26 12,23 11,20 C 11,15 15,10 22,10 Z M 22,10 C 18,10 16,14 17,16 M 15,18 C 18,16 20,18 20,20 M 24,14 A 1.5,1.5 0 1,1 24,17 A 1.5,1.5 0 1,1 24,14 Z'
                : pType === 'b'
